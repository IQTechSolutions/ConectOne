...
using Progolf.Blazor.ServerClient.Components;
using Progolf.Blazor.ServerClient.Components.Account;
using Radzen;
...
using Progolf.Blazor.ServerClient;
using Progolf.Blazor.ServerClient.DataSeeder;
...
builder.Services.AddControllers().AddApplicationPart(typeof(FilingModule.Infrastucture.AssemblyReference).Assembly)
    ...
    .AddApplicationPart(typeof(AccomodationModule.Infrastructure.AssemblyReference).Assembly);
