...
public partial class ItineraryItemTemplateModal
{
    ...
    /// </summary>
    [Parameter] public ItineraryEntryItemTemplateViewModel Template { get; set; } = new ItineraryEntryItemTemplateViewModel();
