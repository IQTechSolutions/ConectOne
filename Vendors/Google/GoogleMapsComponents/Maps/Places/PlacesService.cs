...
public class PlacesService
{
    ...
    /// <summary>
    /// Initializes a new instance of the PlacesService class with the specified JavaScript object reference.
    /// </summary>
    /// <param name="jsObjectRef">A reference to the underlying JavaScript object that provides access to the Places API. Cannot be null.</param>
