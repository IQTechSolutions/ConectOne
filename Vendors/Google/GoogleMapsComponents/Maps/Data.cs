...
public class MapData : EventEntityBase, IEnumerable<Feature>, IDisposable
{
    ...
    /// </summary>
    /// <returns>An enumerator that can be used to iterate through the collection of <see cref="Data.Feature"/> objects.</returns>
    ...
    /// <returns></returns>
    public Task<Data.Feature> Add(OneOf<Feature, FeatureOptions>? feature)
    {
