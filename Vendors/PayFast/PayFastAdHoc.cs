...
namespace PayFast
{
    ...
    public class PayFastAdHoc : PayFastApiBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the PayFastAdHoc class using the specified PayFast settings.
        /// </summary>
        /// <param name="payfastSettings">The PayFastSettings object that contains configuration information required for PayFast integration. Cannot
        /// be null.</param>
        ...
        {
            return await Charge(token: token, amount: amount, item_name: item_name, item_description: string.Empty, testing: testing);
        }
