...
namespace ConectOne.Infrastructure.Controllers
{
    ...
    public class BaseContactInfoApiController<TParent>(IContactInfoService<TParent> service) : Controller
    {
        ...
        /// </returns>
        [HttpGet("contactNumbers/{contactNumberId}")]
        public async Task<IActionResult> GetContactNumberById(string contactNumberId)
        {
        ...
        [HttpPut("contactNumbers")]
        public async Task<IActionResult> CreateContactNumber([FromBody] ContactNumberDto contactNumber)
        {
        ...
        [HttpPost("contactNumbers")]
        public async Task<IActionResult> UpdateContactNumber([FromBody] ContactNumberDto customer)
        {
        ...
        [HttpDelete("contactNumbers/{contactNumberId}")]
        public async Task<IActionResult> DeleteContactNumberAsync(string contactNumberId)
        {
            var result = await _service.DeleteContactNumberAsync(contactNumberId);
            return Ok(result);
        }
        ...
        {
            var emailAddresses = await _service.AllEmailAddressesAsync(parentId);
        ...
        [HttpGet("/emailAddresses/{emailAddressId}")]
        public async Task<IActionResult> GetEmailAddressById(string emailAddressId)
        {
            var emailAddress = await _service.EmailAddressAsync(emailAddressId);
        ...
        [HttpPut("emailAddresses")]
        public async Task<IActionResult> CreateEmailAddress([FromBody] EmailAddressDto emailAddress)
        {
        ...
        /// </param>
        /// <returns>An HTTP result indicating success or failure of the update.</returns>
        [HttpPost("emailAddresses")]
        public async Task<IActionResult> UpdateEmailAddress([FromBody] EmailAddressDto emailAddress)
        {
            if (emailAddress is null)
        ...
        /// <returns>An HTTP result indicating success or failure of the deletion.</returns>
        [HttpDelete("emailAddresses/{emailAddressId}")]
        public async Task<IActionResult> DeleteEmailAddressAsync(string emailAddressId)
        {
            var result = await _service.DeleteEmailAddressAsync(emailAddressId);
            return Ok(result);
        }
