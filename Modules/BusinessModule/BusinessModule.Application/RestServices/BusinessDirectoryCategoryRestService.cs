...
{
    /// <summary>
    /// Provides a REST-based implementation of the <see cref="IBusinessDirectoryCategoryService"/> interface for
    /// managing business directory categories.
    /// </summary>
    /// <remarks>This service interacts with an underlying HTTP provider to perform operations such as
    /// retrieving, creating, updating, and deleting categories, as well as managing category associations and images.
    /// It supports asynchronous operations and is designed to handle various category-related use cases, including
    /// pagination, filtering, and hierarchical relationships.</remarks>
    /// <param name="provider"></param>
    public class BusinessDirectoryCategoryRestService(IBaseHttpProvider provider) : IBusinessDirectoryCategoryService
    {
        /// <summary>
        ...
        {
            var result = await provider.GetAsync<int>($"businessdirectory/categories/count/{categoryPageParameters.GetQueryString()}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>(string.IsNullOrEmpty(parentId) ? "businessdirectory/categories/all" : $"businessdirectory/categories/all/{parentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>($"businessdirectory/categories/byDepartment/{departmentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>(string.IsNullOrEmpty(parentId) ? "businessdirectory/categories/bottomlevel" : $"businessdirectory/categories/bottomlevel/{parentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>($"businessdirectory/categories/entitycategories/{entityId}");
            return result;
        }
        ...
        {
            var result = await provider.GetPagedAsync<CategoryDto, CategoryPageParameters>("businessdirectory/categories/paged", categoryPageParameters);
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<CategoryDto>($"businessdirectory/categories/{categoryId}");
            return result;
        }
        ...
        {
            var result = await provider.PutAsync<CategoryDto, CategoryDto>($"businessdirectory/categories", category);
            return result;
        }
        ...
        {
            var result = await provider.PostAsync<CategoryDto, CategoryDto>($"businessdirectory/categories", category);
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"businessdirectory/categories", categoryId);
            return result;
        }
        ...
        {
            var result = await provider.PostAsync($"businessdirectory/categories/entitycategory/{categoryId}/{entityId}");
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"businessdirectory/categories/entitycategory/{categoryId}/{entityId}", "");
            return result;
        }
        ...
        {
            var result = await provider.PostAsync($"businessdirectory/categories/addImage", request);
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"businessdirectory/categories/deleteImage", imageId);
            return result;
        }
    }
}
