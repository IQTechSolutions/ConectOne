...
/// <summary>
/// Provides API endpoints for managing business categories in the business directory.
/// </summary>
/// <remarks>This controller allows clients to perform CRUD operations on business categories,  including
/// retrieving paged or full lists of categories, fetching a specific category by ID,  creating new categories, updating
/// existing ones, and deleting categories.</remarks>
/// <param name="service"></param>
[Route("api/businessdirectory/categories"), ApiController]
public class BusinessCategoryController(IRepository<EntityImage<Category<BusinessListing>, string>, string> imageRepository, IBusinessDirectoryCategoryService categoryService) : ControllerBase
{
    /// <summary>
    ...
    [HttpGet("count")]
    public async Task<IActionResult> GetCountAsync([FromQuery] CategoryPageParameters parameters)
    {
    ...
    [HttpGet("paged")]
    public async Task<IActionResult> GetPagedAsync([FromQuery] CategoryPageParameters parameters)
    {
    ...
    public async Task<IActionResult> GetChildrenAsync(string parentId)
    {
    ...
    [HttpGet("bottomlevel")]
    public async Task<IActionResult> GetAllBottomLevelActivityCategories()
    {
    ...
    [HttpGet("bottomlevel/{parentId}")]
    public async Task<IActionResult> GetAllBottomLevelActivityCategories(string parentId)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> UpdateAsync([FromBody] CategoryDto model)
    {
    ...
    [HttpGet("entitycategories/{entityId}")]
    public async Task<IActionResult> GetEntityCategoriesAsync(string entityId)
    {
    ...
    [HttpPost("entitycategory/{categoryId}/{entityId}")]
    public async Task<IActionResult> AddEntityCategoryAsync(string categoryId, string entityId)
    {
    ...
    [HttpDelete("entitycategory/{categoryId}/{entityId}")]
    public async Task<IActionResult> RemoveEntityCategoryAsync(string categoryId, string entityId)
    {
    ...
    {
        var image = new EntityImage<Category<BusinessListing>, string>(request.ImageId, request.EntityId) { Selector = request.Selector, Order = request.Order };
