...
/// <summary>
/// API controller for managing vacation title templates.
/// </summary>
[Route("api/vacation-title-templates"), ApiController]
public class VacationTitleTemplatesController(IVacationTitleTemplateService service) : Controller
{
    ...
    /// </summary>
    [HttpPut] public async Task<IActionResult> CreateAsync(VacationTitleTemplateDto dto)
    {
    ...
    /// </summary>
    [HttpPost] public async Task<IActionResult> UpdateAsync(VacationTitleTemplateDto dto)
    {
