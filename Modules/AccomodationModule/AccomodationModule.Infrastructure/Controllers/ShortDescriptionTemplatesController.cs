...
/// <summary>
/// API controller for managing short description templates.
/// </summary>
[Route("api/short-description-templates"), ApiController]
public class ShortDescriptionTemplatesController(IShortDescriptionTemplateService service) : Controller
{
    ...
    /// </summary>
    [HttpPut] public async Task<IActionResult> CreateAsync(ShortDescriptionTemplateDto dto)
    {
    ...
    /// </summary>
    [HttpPost] public async Task<IActionResult> UpdateAsync(ShortDescriptionTemplateDto dto)
    {
