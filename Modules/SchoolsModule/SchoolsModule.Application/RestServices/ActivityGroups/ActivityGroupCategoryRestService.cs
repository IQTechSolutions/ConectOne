...
namespace SchoolsModule.Application.RestServices.ActivityGroups
{
    ...
    public class ActivityGroupCategoryRestService(IBaseHttpProvider provider) : IActivityGroupCategoryService
    {
        /// <summary>
        ...
        {
            var result = await provider.GetAsync<int>($"activities/categories/count/{categoryPageParameters.GetQueryString()}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>(string.IsNullOrEmpty(parentId) ? "activities/categories/all" : $"activities/categories/all/{parentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>($"activities/categories/byDepartment/{departmentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>(string.IsNullOrEmpty(parentId) ? "activities/categories/bottomlevel" : $"activities/categories/bottomlevel/{parentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>($"activities/categories/entitycategories/{entityId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<CategoryDto>($"activities/categories/{categoryId}");
            return result;
        }
        ...
        {
            var result = await provider.PutAsync<CategoryDto, CategoryDto>($"activities/categories", category);
            return result;
        }
        ...
        {
            var result = await provider.PostAsync<CategoryDto, CategoryDto>($"activities/categories", category);
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"activities/categories", categoryId);
            return result;
        }
        ...
        {
            var result = await provider.PostAsync($"activities/categories/entitycategory/{categoryId}/{entityId}");
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"activities/categories/entitycategory/{categoryId}/{entityId}", "");
            return result;
        }
        ...
        {
            var result = await provider.PostAsync($"activities/categories/addImage", request);
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"activities/categories/deleteImage", imageId);
            return result;
        }
    }
}
