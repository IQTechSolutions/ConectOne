...
namespace SchoolsModule.Infrastructure.Implementation
{
    ...
    /// </para>
    /// </remarks>
    public class ParentService(ISchoolsModuleRepoManager schoolsModuleRepoManager, IExcelService excelService, IChatGroupService chatGroupService,
        IRepository<EntityImage<Parent, string>, string> parentImageRepo, IUserService userService, IRepository<ContactNumber<Parent>, string> contactNumberRepo, 
        IRepository<EmailAddress<Parent>, string> emailAddressRepo) : ContactIntoService<Parent>(contactNumberRepo, emailAddressRepo), IParentService
    {
        /// <summary>
