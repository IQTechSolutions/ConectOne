...
/// </summary>
[Route("api/products/categories"), ApiController]
public class ProductCategoryController(IProductCategoryService categoryService, IRepository<EntityImage<Category<Product>, string>, string> imageRepository) : ControllerBase
{
    /// <summary>
    ...
    {
        var image = new EntityImage<Category<Product>, string>(request.ImageId, request.EntityId) { Selector = request.Selector, Order = request.Order };
