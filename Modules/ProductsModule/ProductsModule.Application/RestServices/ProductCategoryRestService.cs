...
{
    /// <summary>
    /// Provides RESTful operations for managing product categories, including retrieving, creating, updating,  and
    /// deleting categories, as well as managing category relationships and associated images.
    /// </summary>
    /// <remarks>This service acts as an abstraction over HTTP-based operations for interacting with product
    /// category data.  It supports operations such as retrieving paginated or hierarchical category data, managing
    /// associations  between categories and entities, and handling category images. The service relies on an <see
    /// cref="IBaseHttpProvider"/>  for making HTTP requests.</remarks>
    /// <param name="provider"></param>
    public class ProductCategoryRestService(IBaseHttpProvider provider) : IProductCategoryService
    {
        /// <summary>
        ...
        {
            var result = await provider.GetAsync<int>($"products/categories/count/{categoryPageParameters.GetQueryString()}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>(string.IsNullOrEmpty(parentId) ? "products/categories/all" : $"products/categories/all/{parentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>($"products/categories/byDepartment/{departmentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>(string.IsNullOrEmpty(parentId) ? "products/categories/bottomlevel" : $"products/categories/bottomlevel/{parentId}");
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<IEnumerable<CategoryDto>>($"products/categories/entitycategories/{entityId}");
            return result;
        }
        ...
        {
            var result = await provider.GetPagedAsync<CategoryDto, CategoryPageParameters>("products/categories/paged", categoryPageParameters);
            return result;
        }
        ...
        {
            var result = await provider.GetAsync<CategoryDto>($"products/categories/{categoryId}");
            return result;
        }
        ...
        {
            var result = await provider.PutAsync<CategoryDto, CategoryDto>($"products/categories", category);
            return result;
        }
        ...
        {
            var result = await provider.PostAsync<CategoryDto, CategoryDto>($"products/categories", category);
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"products/categories", categoryId);
            return result;
        }
        ...
        {
            var result = await provider.PostAsync($"products/categories/entitycategory/{categoryId}/{entityId}");
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"products/categories/entitycategory/{categoryId}/{entityId}", "");
            return result;
        }
        ...
        {
            var result = await provider.PostAsync($"products/categories/addImage", request);
            return result;
        }
        ...
        {
            var result = await provider.DeleteAsync($"products/categories/deleteImage", imageId);
            return result;
        }
    }
}
